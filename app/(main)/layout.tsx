    ...
    <div className="min-h-screen bg-linear-to-br from-black to-[#0a0a0a] text-white flex">
      ...
      <aside className="w-64 border-r border-white/10 bg-black/20 backdrop-blur-xl flex-col p-6 hidden md:flex">
        ...
        <nav className="flex-1 space-y-2">
          ...
          <NextLink href="/resources" className="block px-4 py-2 rounded-lg hover:bg-white/5 transition-colors">
            Resources
          </NextLink>
      ...
      <main className="flex-1 overflow-y-auto">
        <header className="md:hidden border-b border-white/10 p-4 bg-black/20 backdrop-blur-xl sticky top-0 z-10 flex justify-between items-center">
          <h1 className="font-bold">Grace Mentor</h1>
